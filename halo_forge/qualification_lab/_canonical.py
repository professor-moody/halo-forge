"""Canonical, immutable JSON values used by qualification identities."""
...
def thaw_json(value: Any) -> Any:
    """Return a mutable, JSON-serializable copy of a frozen value."""
...
class FrozenJsonMap(Mapping[str, Any]):
    """A recursively immutable mapping with deterministic key order."""
